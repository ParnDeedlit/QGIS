...
const char *QgsApplication::QGIS_ORGANIZATION_NAME = "military gis";
const char *QgsApplication::QGIS_ORGANIZATION_DOMAIN = "military.org";
const char *QgsApplication::QGIS_APPLICATION_NAME = "military gis";
